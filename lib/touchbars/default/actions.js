...
export default class AtomTouchBarLoadedActions {
  ...
  goJake() {
    ...
    var selectJake = Math.floor(Math.random()*2);
        ...
        if (selectJake == 1) {
          ...
          this.fillCircle({
            ...
            this.fillCircle({
              ...
              y: this.canvas.height*6.25 +eye_y,
              size: 300
            });
            this.setFillStyle('rgba(251, 201, 43, 1)')
            this.fillCircle({
            ...
            this.fillCircle({
              x: this.canvas.width*(1/2),
              y: this.canvas.height*6.25 + eye_y +12,
              size: 288
            });
            this.fillCircle({
              x: this.canvas.width*(1/2),
              y: this.canvas.height*6.25 + eye_y + 20,
              size: 288
            });
            this.fillCircle({
              x: this.canvas.width*(1/2),
              y: this.canvas.height*6.25 + eye_y + 30,
              size: 296
            });
            //left jowel
            this.setFillStyle('rgba(0, 0, 0, 1)')
            this.fillCircle({
              x: this.canvas.width*(1/2)-200,
              y: this.canvas.height*6.25 + 20 + eye_y,
              size: 100
            });
            this.setFillStyle('rgba(251, 201, 43, 1)')
            this.fillCircle({
            ...
            this.fillCircle({
              x: this.canvas.width*(1/2)-200,
              y: this.canvas.height*6.25 + 8 + eye_y,
              size: 88
            });
            this.fillCircle({
              x: this.canvas.width*(1/2)-200,
              y: this.canvas.height*6.25 - 4 + eye_y,
              size: 88
            });
            this.fillCircle({
              x: this.canvas.width*(1/2)-200,
              y: this.canvas.height*6.25 - 12 + eye_y,
              size: 88
            });
            //Mouth
            this.setFillStyle('rgba(0, 0, 0, 1)')
            this.fillCircle({
              x: this.canvas.width*(1/2),
              y: this.canvas.height*6.25 -40 +eye_y,
              size: 112
            });
            this.setFillStyle('rgba(58, 25, 45, 1)')
            this.fillCircle({
              x: this.canvas.width*(1/2),
              y: this.canvas.height*6.25 -40 +eye_y,
              size: 106
            ...
            this.fillCircle({
              x: this.canvas.width*(1/2),
              y: this.canvas.height*6.25 -100 +eye_y,
              size: 112
            });
            eye_y -= eye_movespeed;
